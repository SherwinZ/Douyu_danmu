...
# 输入目前目录下的txt文件名
with open('dasima_20215.txt','r',encoding='utf-8') as f:
    text = f.read()
    f.close()
...
cloud = WordCloud(
    background_color='#EEEEEE',      # 参数为设置背景颜色,默认颜色则为黑色
    font_path="FZLTKHK.ttf", # 使用指定字体可以显示中文，或者修改wordcloud.py文件字体设置并且放入相应字体文件
